# Contributing to AiVerse-Chat

Thank you for your interest in contributing to AiVerse-Chat! We welcome contributions from the community and truly appreciate your effort to improve the project.
...
2. **Clone your fork** locally:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/AiVerse-Chat.git
   cd AiVerse-Chat
   ```
...
We sincerely appreciate your contribution to AiVerse-Chat.
